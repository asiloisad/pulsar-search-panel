...
module.exports = class ProjectFindView {
  ...
  render() {
    return $.div(
      { tabIndex: -1, className: "search-panel-project padded" },
      $.header(
        { className: "header" },
        $.span(
          {
      ...
      $.section(
        ...
        $.div(
          ...
          etch.dom(TextEditor, {
            ...
            mini: true,
            placeholderText:
              'Glob pattern: `src/**` to search in "src"; `*.js` for all JavaScript files; `!src/**` to exclude "src"; `src/**,!*.json` to combine patterns',
